...
- **Don't schedule a check-in after pushing.** CLAUDE.md's "No scheduled check-ins" rule
  applies here — the session's job ends once the PR is open, not once it merges.
