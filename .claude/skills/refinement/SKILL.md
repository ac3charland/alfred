...
1. **A spec authored as a self-contained HTML plan at `docs/specs/<REF>.html`** (e.g.
   `docs/specs/ALF-42.html`, using the story's ref). Write it the way Claude Code's "unreasonable
   effectiveness of HTML" guidance shows — a rich, scannable document a human will actually open
   and review, not a wall of prose:
