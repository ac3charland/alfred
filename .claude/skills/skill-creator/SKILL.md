...
- **Describe the skill; don't inline its content.** The description says *what the skill covers and when to reach for it* — not the instructions themselves. Naming the topics it covers aids keyword overlap ("…covers the body-vs-references split, duplication, not narrating the edit"); reproducing the actual rules ("keep bodies lean, never duplicate, never narrate the edit") turns the description into a second copy of the body that drifts and wastes the triggering budget.
