 ...
 * cross-project "Needs human action" queue — the module's default view (ALF-174) — from the
 * shell-seeded CodeProvider. A real static segment so it deep-links/hard-loads server-side and
 * wins precedence over the sibling `[project-id]` dynamic route in the App Router. The bare
 * `/code` renders the same queue; this route is its explicit, shareable name.
 */
