 ...
 * `/code` → the "Needs human action" queue, the module's default view since ALF-174) from the
 * shell-seeded CodeProvider. Switching to a project board, or back to Tasks, is then an instant
 * client-side URL change (see ModuleRouter / ViewLink).
 */
