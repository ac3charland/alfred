...
//
// The epic header edits `notes` and archives / un-archives via `archived_at` (set to an
// ISO timestamp to archive, null to un-archive). Archiving drops the epic off the active
// board (the M3 read filter on `archived_at`); un-archiving restores it.
// ---------------------------------------------------------------------------
