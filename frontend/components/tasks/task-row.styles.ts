...
/**
 * Padding on the inner (fading) layer of a reveal that wraps a compact capture box — the row's
 * add-subtask field and the folder header's capture box alike. `py-1` gives the field's teal
 ...
 * (`ring-2` + `ring-offset-1`), which the 4px `px-1` clears.
 */
export const captureRevealClass = 'px-1 py-1';
