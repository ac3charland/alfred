 ...
 * opening its PR, it has already stopped reading further files. Scoped to the PROACTIVE case —
 * responding to an inbound CI-failure or comment event stays required, as does scheduling a
